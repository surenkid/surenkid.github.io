...
其实amh4.2后台删除网站后，网站的目录文件还是会存在/home/wwwroot/hi.ktsee.uum.cc（例如网站是hi.ktsee.uum.cc）,如果试图直接删除，会提示无法删除该目录，大意是mysql进程占用中。搜寻了官网，amh老大给出的解答是，两种方法可以完整的删除一个网站：
...
然后回到终端，删除整个目录
    ...
    sudo rm -R /home/wwwroot/hi.ktsee.uum.cc
...
直接在后台里删掉相应的网站，然后回到中端，先解除mysql进程挂载
    ...
    umount /home/wwwroot/hi.ktsee.uum.cc/tmp/mysql.sock;
